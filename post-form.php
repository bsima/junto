...
<div id="postbox">
		<ul id="post-types">
			...
			<li><a id="post" class="post-format-button"<?php if ( 'post' == $post_format || 'standard' == $post_format ) : ?> class="selected"<?php endif; ?> href="<?php echo site_url( '?p=post' ); ?>" title="<?php esc_attr_e( 'Discussion Post', 'p2' ); ?>"><?php _e( 'Discussion Post', 'p2' ); ?></a></li>
