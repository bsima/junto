  ...
  <div id="main">
    <h2>
      <?php if ( is_home() or is_front_page() ) : ?>
        <?php _e( 'Recent Quotes', 'p2' ); ?> <?php if ( p2_get_page_number() > 1 ) printf( __( 'Page %s', 'p2' ), p2_get_page_number() ); ?>
      <?php else : ?>
        <?php printf( _x( 'Quotes from %s', 'Month name', 'p2' ), get_the_time( 'F, Y' ) ); ?>
      <?php endif; ?>
